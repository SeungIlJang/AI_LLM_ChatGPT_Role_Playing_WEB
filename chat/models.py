...
class RolePlayingRoom(models.Model):
    ...
    situation_en = models.CharField(
        ...
        help_text="It is used directly for GPT prompts. If left blank, the situations field will be translated and automatically reflected.",
    )
    ...
    my_role_en = models.CharField(
        ...
        help_text="It is used directly for GPT prompts. If left blank, the my_role field will be translated and automatically reflected.",
    )
    ...
    gpt_role_en = models.CharField(
        ...
        help_text="It is used directly for GPT prompts. If left blank, the gpt_role field will be translated and automatically reflected.",
    )
